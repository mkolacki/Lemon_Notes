...
public class Main extends Application
{
    ...
    public void start(final Stage primaryStage)
    {
        ...
        //^^Shouldn't a list of all projects be generated and saved in a file to reference later? This could be part of the loading code. -MC
        ...
        combo.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                //set current project -- Mike C.
                combobox.currentProject = combo.getSelectionModel().getSelectedItem().toString();
            }
        });
        ...
        String titleText;
        if (combobox.currentProject != null) {
            titleText = combobox.currentProject;
        } else {
